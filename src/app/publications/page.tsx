  ...
  return (
    <div className="py-20 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-indigo-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex justify-center mb-12 animate-fade-in-up" style={{ opacity: 0, animationDelay: '0.2s' }}>
          <a
            ...
            className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition-all shadow-lg shadow-purple-500/25 hover:-translate-y-1"
          >
              ...
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                <div className="flex-1">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center flex-shrink-0 animate-float icon-animated" style={{ animationDelay: `${index * 0.2}s` }}>
                  ...
                  >
                    <h2 className="text-xl lg:text-2xl font-bold text-purple-100 group-hover/link:text-white transition-colors mb-3">
                      {publication.title}
                    </h2>
                  </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-shrink-0 inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-purple-500/20 text-purple-300 hover:text-white hover:bg-purple-500/40 font-medium transition-all group/btn"
                >
                  Read Article
                  <svg
        ...
        <div className="mt-16 animate-fade-in-up" style={{ opacity: 0, animationDelay: '0.8s' }}>
          <div className="card p-8 lg:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-white/10 flex items-center justify-center animate-float">
