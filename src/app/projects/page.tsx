  ...
  return (
    <div className="py-20 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-40 left-10 w-80 h-80 bg-indigo-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Featured Projects */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-purple-100 mb-8 flex items-center gap-3">
            <span className="w-10 h-10 rounded-lg bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center animate-pulse">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {featuredProjects.map((project, index) => (
              <div key={project.title} className="card p-8 animate-fade-in-up" style={{ opacity: 0, animationDelay: `${0.2 + index * 0.15}s` }}>
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center flex-shrink-0 animate-float icon-animated" style={{ animationDelay: `${index * 0.3}s` }}>
                  ...
                  <div className="flex gap-3">
                    {project.github && (
                      <a
                        ...
                        className="w-10 h-10 rounded-lg bg-purple-500/20 flex items-center justify-center text-purple-300 hover:text-white hover:bg-purple-500/40 transition-all"
                        aria-label="GitHub"
                      >
                ...
                <p className="text-purple-300/70 mb-6">{project.description}</p>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {otherProjects.map((project, index) => (
              <div key={project.title} className="card p-6 group animate-fade-in-up" style={{ opacity: 0, animationDelay: `${0.5 + index * 0.1}s` }}>
                <div className="flex items-start justify-between mb-3">
                  <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center animate-float icon-animated" style={{ animationDelay: `${index * 0.2}s` }}>
                    <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                    </svg>
                  </div>
                  <div className="flex gap-2">
                    {project.github && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-8 h-8 rounded-lg bg-purple-500/20 flex items-center justify-center text-purple-400 hover:text-white hover:bg-purple-500/40 transition-all"
                        aria-label="GitHub"
                      >
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-2 py-0.5 text-xs bg-purple-500/20 text-purple-400 rounded border border-purple-500/20"
                    >
                      {tag}
                    </span>
                  ))}
